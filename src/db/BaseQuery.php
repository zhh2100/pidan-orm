...
use pidan\db\exception\DataNotFoundException;
use pidan\db\exception\DbException as Exception;
use pidan\db\exception\ModelNotFoundException;
    ...
    public function paginate($listRows = null, $simple = false): Paginator
    {
        ...
        if (!isset($total) && !$simple) {
            ...
            if ($total > 0) {
                ...
                if (!empty($this->model)) {
                    $results = new \pidan\model\Collection([]);
                } else {
                    $results = new \pidan\Collection([]);
                }
            }
        } elseif ($simple) {
