...
use pidan\model\relation\BelongsTo;
use pidan\model\relation\BelongsToMany;
use pidan\model\relation\HasMany;
use pidan\model\relation\HasManyThrough;
use pidan\model\relation\HasOne;
use pidan\model\relation\HasOneThrough;
use pidan\model\relation\MorphMany;
use pidan\model\relation\MorphOne;
use pidan\model\relation\MorphTo;
use pidan\model\relation\MorphToMany;
use pidan\model\relation\OneToOne;
...
trait RelationShip
{
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if ((method_exists($this, $relation) && !method_exists('pidan\Model', $relation)) || isset(static::$macro[static::class][$relation])) {
            return $relation;
        }
